...
public class SwiftGeofirePlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let eventChannel = FlutterEventChannel(name: "geofireStream", binaryMessenger: registrar.messenger())
        ...
        if call.method.elementsEqual("GeoFire.start") {
            ...
            geoFire?.getLocationForKey(id) { location, error in
                if error != nil {
                    ...
                    print("Location for \(id) is [\(String(describing: location?.coordinate.latitude)), \(String(describing: location?.coordinate.longitude))]")
